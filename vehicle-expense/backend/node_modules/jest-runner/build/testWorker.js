'use strict';
/* build-hook-start *//*00001*/try { require('/Users/vimukthibuddika/.cursor/extensions/wallabyjs.console-ninja-1.0.483-universal/out/buildHook/index.js').default({tool: 'jest', checkSum: '20fd6b75cad4b3ad7e88b1VF0YVRkFWVFWVlsLVgUBUVoAAwVT', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/vimukthibuddika/.cursor/extensions/wallabyjs.console-ninja-1.0.483-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20fd6b75cad4b3ad7e88b1VF0YVRkFWVFWVlsLVgUBUVoAAwVT', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

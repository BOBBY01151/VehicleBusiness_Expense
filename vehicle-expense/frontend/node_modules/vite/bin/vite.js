#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/Users/vimukthibuddika/.cursor/extensions/wallabyjs.console-ninja-1.0.483-universal/out/buildHook/index.js').default({tool: 'vite', checkSum: '20f96da5660fa1f7330192URcHSlgPDlQJUlFUBAYFB1NXClcE', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/vimukthibuddika/.cursor/extensions/wallabyjs.console-ninja-1.0.483-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '20f96da5660fa1f7330192URcHSlgPDlQJUlFUBAYFB1NXClcE', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
